const CACHE_NAME='lonewolf-nightvision-v2.0.0';
const SHELL=['./','./index.html','./css/style.css','./js/camera.js','./js/image-processing.js','./js/measurement.js','./js/reticle.js','./js/vr.js','./js/app.js','./manifest.json','./assets/icon-192.png','./assets/icon-512.png'];
