...
LW.measure={
  ...
  distanceFromAngle(angle){if(!Number.isFinite(angle)||angle<=0)return this.outOfRange();const d=this.angleToDistance(angle);if(!Number.isFinite(d)||d<this.min||d>this.max)return this.outOfRange();return{value:d,text:d.toFixed(1)+' M'}},
