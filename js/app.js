...
document.addEventListener('DOMContentLoaded',()=>{load();bind();resize();addEventListener('resize',resize);addEventListener('orientationchange',()=>setTimeout(resize,300));navigator.serviceWorker?.register('./sw.js').catch(console.warn)});
