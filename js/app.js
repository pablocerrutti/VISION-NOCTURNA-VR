...
const DEFAULTS={mode:'green',brightness:1.2,contrast:1.35,gain:1,zoom:.9,fov:50,reticle:true,scale:true,measurement:true,vr:false,vrSeparation:.10,vrScale:1,lastDistance:null};
...
function updateVRHudText(){
 const data=[['modeLabel','cameraLabel','fps'],['modeLabel','cameraLabel','fps']];
 document.querySelectorAll('.vr-hud').forEach((hud,i)=>{
